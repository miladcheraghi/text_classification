...
knn.fit(trainDataFeatures, train["class"])

# Use the KNN to make sentiment label predictions
print("Use KNN to make sentiment label predictions")
...
Plotting.plot_RUC(test["class"], result , title='Confusion matrix for KNN Classifier')

...
print("Cleaning and parsing the test set telegram post...\n")
...
time0 = time()
# Fit the Decision Tree to the training set, using the bag of words as
# features and the sentiment labels as the response variable
#
# This may take a few minutes to run
clf = clf.fit(trainDataFeatures,train["class"])

# Use the Decision Tree to make sentiment label predictions
print("Use the Decision Tree to make sentiment label predictions")
...
Plotting.plot_RUC(test["class"], result , title='ROC curves for Decision Tree Classifier')

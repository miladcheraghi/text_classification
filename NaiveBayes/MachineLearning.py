...
print("Training the Naive Bayse Classifier...")
...
time0 = time()
# Fit the Naive Bayse to the training set, using the bag of words as
# features and the sentiment labels as the response variable
#
# This may take a few minutes to run
clfrNB.fit(trainDataFeatures, train["class"])

# Use the Naive Bayse to make sentiment label predictions
print("Use the Naive Bayse to make sentiment label predictions")
result = clfrNB.predict(testDataFeatures)
